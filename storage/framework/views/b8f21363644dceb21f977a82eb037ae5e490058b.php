            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="<?php echo e(url('/candidato')); ?>" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                                ...
                                <?php $__currentLoopData = $candidato; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="<?php echo e(url('/candidato' . '/' . $item->id)); ?>" accept-charset="UTF-8" style="display:inline">
